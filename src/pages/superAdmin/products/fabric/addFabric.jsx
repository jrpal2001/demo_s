...
import { storeFabric } from '@/api/admin';
...
const AddProductFabric = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await storeFabric(data);
  ...
  return (
    <PageContainer title="Add Fabric Product" description="This is the Add Fabric Product page">
      <Breadcrumb title="Add Product" items={BCrumb} />
      <ParentCard title="Add Fabric">
