...
import { getAccessoriesById, updateAccessories } from '@/api/admin';
...
const EditProductTrimsAccessories = () => {
  ...
  useEffect(() => {
    const fetchProductData = async () => {
      try {
        const response = await getAccessoriesById(id);
  ...
  const onSubmit = async (data) => {
    ...
    console.log(data);
    try {
      const response = await updateAccessories(id, data);
  ...
  const fields = [
    ...
    { label: 'BRAND', id: 'brand', type: 'text', required: 'BRAND is required' },
  ...
  return (
    <PageContainer
      title="Add Trims & Accessories Product"
      description="This is the Add Trims & Accessories Product page"
    >
      <Breadcrumb title="Add Product" items={BCrumb} />
      <ParentCard title="Add Trims & Accessories">
        {isLoading ? (
          <Spinner />
        ) : (
...
export default EditProductTrimsAccessories;
