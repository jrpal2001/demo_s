...
// import { getProductMasterById, updateProductMaster } from '@/api/admin';
...
//       try {
//         const response = await getProductMasterById(id);
...
//     console.log(data);
//     try {
//       const response = await updateProductMaster(id, data);
...
//   return (
//     <PageContainer title="Update Product" description="This is the Update Product page">
//       <Breadcrumb title="Update Product" items={BCrumb} />
//       <ParentCard title="Update Master">
//         {isLoading ? (
//           <Spinner />
//         ) : (
