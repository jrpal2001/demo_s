...
import { storePacking } from '@/api/admin';
import { LoadingButton } from '@mui/lab';
import { useSelector } from 'react-redux';
import { selectCurrentUserType } from '@/store/auth/AuthSlice';

const AddProductPacking = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await storePacking(data);
  ...
  return (
    <PageContainer title="Add Packing Product" description="This is the Add Packing Product page">
      <Breadcrumb title="Add Product" items={BCrumb} />
      <ParentCard title="Add Packing">
...
export default AddProductPacking;
