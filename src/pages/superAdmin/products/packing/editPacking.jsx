...
import { getPackingById, storePacking, updatePacking } from '@/api/admin';
...
const EditProductPacking = () => {
  ...
  const onSubmit = async (data) => {
    ...
    console.log(data);
    try {
      const response = await updatePacking(id, data);
  ...
  return (
    <PageContainer title="Update Packing Product" description="This is the Update Packing Product page">
      <Breadcrumb title="Update Product" items={BCrumb} />
      <ParentCard title="Update Packing">
        {isLoading ? (
          <Spinner />
        ) : (
...
export default EditProductPacking;
