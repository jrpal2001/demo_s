...
import { dealerStore } from '@/api/admin';
...
const AddDealers = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const { oname, odesignation, omobileNumber, oemailOrFax, pname, pdesignation, pmobileNumber, pemailOrFax, ...rest } = data;
            const newData = {
                ...rest,
                primaryContact: {
                    name: data.oname,
                    designation: data.odesignation,
                    mobileNumber: data.omobileNumber,
                    emailOrFax: data.oemailOrFax
                },
                pointOfContactOperations: {
                    name: data.pname,
                    designation:  data.pdesignation,
                    mobileNumber:  data.pmobileNumber,
                    emailOrFax: data.pemailOrFax
                },

            }
            const response = await dealerStore(newData);
                        ...
                        <Grid2 size={12}>
                            <Grid2 container columnSpacing={2}>
                                ...
                                <Grid2 size={{ xs: 12, sm: 6, md: 3, lg: 4 }}>
                                    <CustomFormLabel htmlFor="dealerName">Dealer Name</CustomFormLabel>
                                    <CustomTextField
                                        id="dealerName"
                                ...
                                <Grid2 size={{ xs: 12, sm: 6, md: 3, lg: 4 }}>
                                    <CustomFormLabel htmlFor="typeOfEntity">Type of Entity</CustomFormLabel>
                                    <CustomSelect
                                        id="typeOfEntity"
                                ...
                                <Grid2 size={{ xs: 12, sm: 6, md: 3, lg: 4 }}>
                                    <CustomFormLabel htmlFor="registeredOfficeAddress">Registered Office Address</CustomFormLabel>
                                    <CustomTextField
                                ...
                                <Grid2 size={{ xs: 12, sm: 6, md: 3, lg: 4 }}>
                                    <CustomFormLabel htmlFor="telephone">Contact Number</CustomFormLabel>
                                    <CustomTextField
                                        id="telephone"
