...
import UpdateLotDetailsModal from './UpdateLotDetailsModal';
import { getSrsDispatchesByWorkOrder } from '@/api/srsDispatch.api';
      ...
      renderCell: (params) => {
        return (
          <Button
            sx={{ backgroundImage: 'linear-gradient(orange, orange)', color: 'white' }}
            onClick={() => {
              navigate(`lots`, { state: { rowData: params.row } });
            }}
          >
            Lots
          </Button>
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
        ...
        {role === 'admin' || role === 'merchandiser' ? (
          <Button
            ...
            color="primary"
            onClick={() =>
              navigate(`/${role}/srs-jobcard/workorder/create/${jobCardId}`, {
